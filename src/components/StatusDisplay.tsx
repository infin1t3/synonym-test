      ...
      <div className={`max-w-md w-full text-center p-8 rounded-lg border ${colors.bg} ${colors.border}`}>
        ...
        {action && (
          <button
            ...
            className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white ${colors.button} focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200`}
          >
            {action.label}
          </button>
        )}
